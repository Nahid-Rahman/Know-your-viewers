  ...
  await prisma.siteContent.upsert({
    ...
    create: {
      ...
      gameCategories: [
        {
          icon: "🎯",
          image: "/images/categories/fps-controller.jpg",
          tag: "ACTIVE POOL",
        ...
        {
          icon: "🪂",
          image: "/images/categories/mobile-gaming.jpg",
          tag: "MOBILE POOL",
        ...
        {
          icon: "🔫",
          image: "/images/categories/controller-dim.jpg",
          tag: "MOBILE POOL",
        ...
        {
          icon: "⚔️",
          image: "/images/categories/esports-setup.jpg",
          tag: "MOBILE POOL",
        ...
        {
          icon: "⛏️",
          image: "/images/categories/cubes-abstract.jpg",
          tag: "PC POOL",
